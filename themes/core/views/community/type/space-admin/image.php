...
<div class="page_block">
    ...
    <div class="page_block_header clear_fix">
        <div class="page_block_header_inner _header_inner">
            <?= Yii::t('CommunityModule.communitytype', '<strong>Change</strong> community image'); ?>
        </div>
    </div>
    ...
    <div class="page_info_wrap">
        ...
        <div class="image-upload-container profile-user-photo-container" style="width: 140px; height: 140px; margin-top: 5px;">
            <?php
        ...
        <br>
        <div>
            <a href="#" onclick="javascript:$('#profilefileupload input').click();" class="btn btn-primary">
                <i class="fa fa-cloud-upload"></i>
                <?= Yii::t('CommunityModule.communitytype', 'Upload image'); ?>
            </a>
            ...
            <a id="profile-image-upload-edit-button" style="<?php
               ...
               ?>" href="<?= $community->createUrl('/community/manage/image/crop'); ?>" class="btn btn-primary" data-target="#globalModal" data-toggle="modal">
                <i class="fa fa-edit"></i> <?= Yii::t('CommunityModule.communitytype', 'Crop image'); ?>
            </a>

            <?php /*echo \zikwall\easyonline\modules\core\widgets\ModalDialog::widget(array(
