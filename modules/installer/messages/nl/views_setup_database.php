...
return [
    ...
    'Hostname of your MySQL Database Server (e.g. localhost if MySQL is running on the same machine)' => 'Hostnaam van je MySQL database server (Bijvoorbeeld localhost als MySQL op dezelfde server staat als EasyOnline)',
    'Initializing database...' => 'Databank initialiseren...',
    'Next' => 'Volgende',
    'Ohh, something went wrong!' => 'Oei, er is iets misgelopen!',
    'The name of the database you want to run EasyOnline in.' => 'De naam van de database waar je EasyOnline in wil plaatsen.',
