...
return array (
  ...
  'Default user community for new users' => 'Группа по умолчанию для новых пользователей',
  ...
  'Require community admin approval after registration' => 'Обязательное подтверждение администратором после регистрации',
);
