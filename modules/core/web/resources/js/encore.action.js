/**
 * Thid module can be used by encore sub modules for registering handlers and serves as core module for executing actions triggered in the gui.
 * A module can either register global handler by using the registerHandler functions or use the component mechanism.
 */
encore.module('action', function(module, require, $) {
    var _handler = {};
    ...
    Component.component = 'encore-component';
     ...
     * 
     * @param {type} cfg
     * @returns {encore_action_L5.ActionBinding}
     */
    var ActionBinding = function(options) {
        ...
        // namespaced event e.g. click.encore-action
     ...
     *  
     *  Note: When using encore.modules.client for submitting a form or sending a request and providing the action event, the event.finish will be
    ...
    ActionBinding.prototype.handle = function(options) {
        ...
        try {
            ...
            // As last resort we try to call the action by namespace for handlers like encore.modules.myModule.myAction
     ...
     * 
     * @see {@link encore.modules.content.handleAction}
    ...
    var bindAction = function(parent, type, selector, directHandler) {
        ...
        var actionEvent = type + '.encore-action';
