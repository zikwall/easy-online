 ...
 */
encore.module('ui.additions', function (module, require, $) {
    ...
    var register = function (id, selector, handler, options) {
        ...
        if (!_additions[id] || options.overwrite) {
            ...
            // Make sure additions registrated after encore:ready also affect element
    ...
    var init = function () {
        event.on('encore:ready', function (evt) {
            module.applyTo($('body'));
        });
        ...
        $(document).on('click.encore-jp-play', '.jp-play', function () {
        ...
        $(document).on('click.encore-ui-additions', function () {
            $('.tooltip').remove();
