...
namespace zikwall\easyonline\modules\core\components\compatibility;

use zikwall\easyonline\modules\ui\widgets\MarkdownEditor;
use zikwall\easyonline\modules\ui\widgets\MultiSelectField;
use Yii;
...
class HForm extends \yii\base\Component
{
    ...
    public function render($form)
    {
        ...
        $out = '<div class="' . $this->contentWrapperClass . '">' . $this->renderElements($this->definition['elements']) . '</div>';
        $out .= '<div class="' . $this->footerWrapperClass . '">' .  $this->renderButtons($this->definition['buttons']) . '</div>';
