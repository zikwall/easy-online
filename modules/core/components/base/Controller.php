...
class Controller extends \yii\web\Controller
{
    ...
    {
        return $this->renderPartial('@zikwall/easyonline/modules/core/views/htmlRedirect.php', [
            'url' => Url::to($url)
        ]);
    }
    ...
    {
        return $this->renderPartial('@zikwall/easyonline/modules/core/views/modalClose.php', []);
    }
    ...
    public function setJsViewStatus()
    {
        ...
        if (Yii::$app->request->isPjax) {
            \zikwall\easyonline\modules\admin\widgets\AdminSidebarWidget::setViewState();
        }
    }
}
