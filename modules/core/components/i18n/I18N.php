...
namespace zikwall\easyonline\modules\core\components\i18n;
...
class I18N extends \yii\i18n\I18N
{
     ...
     */
    public $messageOverwritePath = '@zikwall/easyonline/modules/core/messages';
     ...
     *
     * @param \zikwall\easyonline\modules\core\modules\user\models\User $user
     */
        ...
        foreach (Yii::$app->moduleManager->getModules(['includeCoreModules' => true, 'returnClass' => true]) as $moduleId => $className) {
            ...
            if (substr($category, 0, strlen($moduleCategory)) === $moduleCategory) {
                ...
                $this->translations[$moduleCategory . '*'] = [
                    'class' => 'zikwall\easyonline\modules\core\components\i18n\MessageSource',
