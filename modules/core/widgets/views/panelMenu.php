<?php
$this->registerJsFile("@web/resources/jquery.cookie.js", ['position' => yii\web\View::POS_BEGIN]);
$this->registerJsFile("@web/resources/panelMenu.js", ['position' => yii\web\View::POS_BEGIN]);
?>
