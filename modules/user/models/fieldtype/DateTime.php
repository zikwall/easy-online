...
use Yii;
use app\modules\core\libs\DbDateValidator;
...
class DateTime extends BaseType
{
    ...
    public function save()
    {
        ...
        if (!\app\modules\user\models\Profile::columnExists($columnName)) {
            $query = Yii::$app->db->getQueryBuilder()->addColumn(\app\modules\user\models\Profile::tableName(), $columnName, 'DATETIME');
    ...
    {
        $rules[] = array($this->profileField->internal_name, DbDateValidator::class, 'format' => Yii::$app->formatter->dateInputFormat);
