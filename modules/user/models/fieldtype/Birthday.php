...
class Birthday extends Date
{
    ...
    public function save()
    {
        ...
        if (!\zikwall\easyonline\modules\user\models\Profile::columnExists($columnName)) {
            $query = Yii::$app->db->getQueryBuilder()->addColumn(\zikwall\easyonline\modules\user\models\Profile::tableName(), $columnName . '_hide_year', 'INT(1)');
    ...
    public function getFieldRules($rules = array())
    {
        ...
        $rules[] = [$this->profileField->internal_name,
            \zikwall\easyonline\libs\DbDateValidator::class,
