...
use zikwall\easyonline\components\ActiveRecord;
...
class Mentioning extends ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            [
                'class' => \zikwall\easyonline\components\behaviors\PolymorphicRelation::class,
    ...
    {
        return $this->hasOne(\zikwall\easyonline\modules\user\models\User::class, ['id' => 'user_id']);
    }
