...
use zikwall\easyonline\modules\user\authclient\BaseClient;
...
class Registration extends HForm
{
    ...
    public function validate()
    {
        ...
        // Remove optional community assignment before validation
    ...
    public function register(\yii\authclient\ClientInterface $authClient = null)
    {
        ...
        if ($this->models['User']->save()) {
            ...
            if ($authClient !== null) {
                AuthClientHelpers::storeAuthClientForUser($authClient, $this->models['User']);
                $authClient->trigger(BaseClient::EVENT_CREATE_USER, new \yii\web\UserEvent(['identity' => $this->models['User']]));
            }
