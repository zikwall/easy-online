...
\zikwall\easyonline\modules\admin\assets\AdminGroupAsset::register($this);
\zikwall\easyonline\modules\user\assets\UserAsset::register($this);
\zikwall\easyonline\modules\user\assets\UserPickerAsset::register($this);

?>

<?php $this->beginContent('@zikwall/easyonline/modules/user/views/group/_manageLayout.php', ['group' => $group]) ?>
<div class="panel-body">
    <?php $form = ActiveForm::begin(['action' => ['/user/group/add-members']]); ?>
    <div class="form-group">
        <div class="input-group select2-encore-append">
            <?=
            zikwall\easyonline\modules\user\widgets\UserPickerField::widget([
                'model' => $addGroupMemberForm,
                'attribute' => 'userGuids',
                'url' => Url::to(['/user/group/new-member-search', 'id' => $group->id]),
