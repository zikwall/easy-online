...
$.fn.userpicker = function (options) {
    ...
    function showHintUser() {
        ...
        var _html = '<div id="maxUsersHint" style="display: none;" class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">x</button><strong>Sorry!</strong> You can add a maximum of ' + options.maxUsers + ' users as admin for this community.</div>';
...
$.fn.userpicker.addUserTag = function (guid, image_url, name, id) {
    if ($('#user_' + guid + ' a').attr('data-taken') != "true") {
        ...
        var _tagcode = '<li class="userInput" id="' + id + '_' + guid + '">' + name + '<i class="fa fa-times-circle"></i></li>';
