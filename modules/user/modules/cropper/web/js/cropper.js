        ...
        var $widget = $(this).closest('.cropper-widget'),
            ...
            cropper = {
                ...
                showError: function (error) {
                    if (error == '') {
                        cropper.$widget.parents('.form-community').removeClass('has-error').find('.help-block').text('');
                    } else {
                        cropper.$widget.parents('.form-community').addClass('has-error').find('.help-block').text(error);
                    }
                },
