...
namespace zikwall\easyonline\modules\user\modules\cropper;

use zikwall\easyonline\modules\user\modules\cropper\assets\CropperAsset;
    ...
    public static function registerTranslations()
    {
        if (!isset(Yii::$app->i18n->translations['cropper']) && !isset(Yii::$app->i18n->translations['cropper/*'])) {
            Yii::$app->i18n->translations['cropper'] = [
                ...
                'basePath' => '@zikwall/easyonline/modules/user/modules/cropper/messages',
