...
namespace zikwall\easyonline\modules\user\modules\friendship\models;

use zikwall\easyonline\modules\core\components\ActiveRecord;
use zikwall\easyonline\modules\user\models\User;
use zikwall\easyonline\modules\user\modules\friendship\events\FriendshipEvent;
use zikwall\easyonline\modules\user\modules\friendship\notifications\RequestDeclined;
...
class Friendship extends ActiveRecord
{
    ...
    /**
     * @event \zikwall\easyonline\modules\friendship\FriendshipEvent
     */
    ...
    /**
     * Возвращает состояние дружбы между пользователями
     * 
     * @param User $user
     * @param User $friend
     * 
    ...
    /**
     * Возвращает запрос для друзей пользователя
     *
     */
    ...
    /**
     * Возвращает запрос для отправленных и не одобренных запросов друга пользователя
     * 
     * @return \yii\db\ActiveQuery
     */
    ...
    /**
     * Возвращает запрос для полученных и не ответивших запросов друга пользователя
     * 
     * @param User $user
     * @return \yii\db\ActiveQuery
     */
    public static function getReceivedRequestsQuery(User $user)
    {
        $query = User::find();
    ...
    /**
     * Добавляет дружбу или отправляет запрос
     *
     * @param User $user
     * @param User $friend
     * @return bool
     */
    public static function add(User $user, User $friend)
    {
    ...
    /**
     * Отменяет дружбу или запрос другу
     * 
     * @param User $user
     * @param User $friend
     */
