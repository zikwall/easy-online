...
class AuthChoice extends \yii\authclient\widgets\AuthChoice
{
     ...
     * @param $clients
     * @return \zikwall\easyonline\modules\user\authclient\BaseFormAuth
     */
    ...
    protected function renderMainContent()
    {
        ...
        /*$this->view->registerCssFile('@user/authChoice.css');
        $this->view->registerJsFile('@user/authChoice.js');*/

        echo Html::beginTag('div', ['class' => 'authChoice']);

        $i = 0;
        $extraCssClass = 'btn-sxm btn-simple';
    ...
    public function clientLink($client, $text = null, array $htmlOptions = array())
    {
        ...
        $htmlOptions['class'] .= ' ' . 'btn btn-primary btn-round btn-ac-' . $client->getName();
