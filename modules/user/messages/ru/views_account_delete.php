...
return [
    ...
    'Sorry, as an owner of a workspace you are not able to delete your account!<br />Please assign another owner or delete them.' => 'Извините, администратор сообщества не может удалить свою учетную запись! Пожалуйста назначьте другого администратора и повторите попытку.',
];
