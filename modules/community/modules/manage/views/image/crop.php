    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?= Yii::t('CommunityModule.views_admin_cropImage', '<strong>Modify</strong> community image'); ?></h4>
        </div>
        ...
        <div class="modal-footer">
            ...
            echo \zikwall\easyonline\widgets\AjaxButton::widget([
                ...
                'ajaxOptions' => [
                    ...
                    'url' => $community->createUrl('/community/manage/image/crop'),
                ],
                'htmlOptions' => [
            ...
            <button type="button" class="btn btn-primary"
                    data-dismiss="modal"><?= Yii::t('CommunityModule.views_admin_cropImage', 'Close'); ?></button>
